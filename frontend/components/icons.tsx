...
export const CakeIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 15.546c-.523 0-1.046.151-1.5.454a2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0 2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0c-.454-.303-.977-.454-1.5-.454V12a1 1 0 011-1h12a1 1 0 011 1v3.546zM12 13V9a1 1 0 011-1h.5a1 1 0 011 1v3a1 1 0 01-1 1h-1a1 1 0 01-1-1zm0 0V9a1 1 0 00-1-1h-.5a1 1 0 00-1 1v3a1 1 0 001 1h1a1 1 0 001-1z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2m0 4V7m0 2v1m0 4v2" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3c-1.105 0-2 .895-2 2s.895 2 2 2 2-.895 2-2-.895-2-2-2zM12 21a2 2 0 100-4 2 2 0 000 4z" />
    </svg>
);
...
export const SunIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364-6.364l-.707.707M6.343 17.657l-.707.707M16.243 17.657l.707.707M7.757 7.757l.707.707M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
  </svg>
);
